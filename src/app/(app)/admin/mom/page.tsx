            ...
            <StaggerList className="space-y-2">
              {moms.map((mom) => (
                <StaggerItem key={mom.id}>
                  <Link href={`/admin/mom/${mom.cycle.id}`}>
                    <Card className="border-0 shadow-sm border-l-4 border-l-purple-400 hover:shadow-md transition-shadow cursor-pointer">
                      <CardContent className="p-4 flex items-center justify-between gap-3">
