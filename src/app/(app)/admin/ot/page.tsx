...
export default async function OtDashboard() {
  ...
  const stats = [
    {
      ...
      value: `₹${totalOtAmount.toLocaleString("en-IN", { maximumFractionDigits: 0 })}`,
      sub: `${totalOtHours.toFixed(1)} hrs approved`,
      href: "/admin/ot/records",
      icon: Clock,
      accent: "stat-teal",
  ...
  const quickLinks = [
    { href: "/admin/ot/attendance", label: "Attendance Import", desc: "Add attendance logs", icon: ClipboardList },
    { href: "/admin/ot/holidays", label: "Holiday Manager", desc: "Manage holiday calendar", icon: Calendar },
    { href: "/admin/ot/records", label: "OT Records", desc: "Approve / reject OT", icon: Layers },
    { href: "/admin/ot/lop", label: "LOP Manager", desc: "Manage LOP entries", icon: TrendingDown },
    { href: "/admin/ot/payroll", label: "Final Payroll", desc: "Monthly summary & export", icon: FileText },
    { href: "/admin/ot/settings", label: "OT Settings", desc: "Configure rates & slabs", icon: AlertCircle },
  ];
      ...
      <FadeIn>
        <div className="flex items-start justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="ds-body mt-1">{monthLabel} — Overtime, Comp-Off, and Payroll Adjustments</p>
          </div>
          <Link
            href="/admin/ot/attendance"
