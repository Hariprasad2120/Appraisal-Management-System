      ...
      <FadeIn delay={0.3}>
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            ...
            { href: "/ams/admin/users", label: "User Management", desc: "Invites, access & seats" },
            { href: "/ams/admin/cycles", label: "All Cycles", desc: "View appraisal cycles" },
            { href: "/ams/admin/slabs", label: "Increment Slabs", desc: "Configure hike bands" },
            {
              href: "/ams/admin/extensions",
              label: "Extensions",
