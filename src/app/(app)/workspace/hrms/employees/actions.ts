...
export async function createEmployeeAction(formData: FormData) {
  ...
  redirect(`/workspace/hrms/employees/${created.id}`);
}
...
export async function updateEmployeeAction(id: string, formData: FormData) {
  ...
  revalidatePath("/workspace/hrms/employees");
  revalidatePath(`/workspace/hrms/employees/${id}`);
  redirect(`/workspace/hrms/employees/${id}`);
}
...
export async function deleteEmployeeAction(formData: FormData) {
  ...
  revalidatePath("/workspace/hrms/employees");
  redirect("/workspace/hrms/employees");
}
...
export async function upsertSalaryAction(userId: string, formData: FormData) {
  ...
  redirect(`/workspace/hrms/employees/${userId}`);
}
