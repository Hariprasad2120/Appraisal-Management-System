...
const ManagementCharts = dynamic(() => import("./management-charts").then((m) => m.ManagementCharts));
      ...
      <FadeIn delay={0.3}>
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            ...
            { href: "/appraisal/users", label: "User Management", desc: "Invites, access & seats" },
            { href: "/appraisal/cycles", label: "All Cycles", desc: "View appraisal cycles" },
            { href: "/appraisal/slabs", label: "Increment Slabs", desc: "Configure hike bands" },
            {
              href: "/appraisal/extensions",
              label: "Extensions",
