                    ...
                    {employeePerf.map((e, i) => (
                      <tr key={e.id} className="hover:bg-muted/40 transition-colors">
                        ...
                        <td className="px-4 text-green-600 dark:text-green-400 font-medium text-xs">
                          {e.lastHike ? `+${fmt(e.lastHike)}` : "â€”"}
                        </td>
                        <td className="px-4 text-muted-foreground text-xs">
                          {e.grossAnnum ? fmt(e.grossAnnum) : "â€”"}
                        </td>
                      </tr>
                    ))}
                  </tbody>
          ...
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm text-foreground">
                Appraisal Results â€” Action Required
              </CardTitle>
              <Link
                href="/history"
                    ...
                    return (
                      <tr key={emp.id} className="hover:bg-muted/40 transition-colors">
                        ...
                        <td className="px-4 text-foreground font-semibold text-xs">
                          {emp.salary ? fmt(Number(emp.salary.grossAnnum)) : "â€”"}
                        </td>
                        <td className="px-4 text-muted-foreground text-xs">
                          {emp.salary ? fmt(Number(emp.salary.ctcAnnum)) : "â€”"}
                        </td>
                        <td className="px-4 text-muted-foreground text-xs">
                          {emp.salary ? fmt(Number(emp.salary.basic)) : "â€”"}
                        </td>
                        <td className="px-4 text-muted-foreground text-xs">
