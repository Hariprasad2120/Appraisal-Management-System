...
import { getHrmsPoliciesPath, getHrmsPolicyPath } from "@/modules/hrms/lib/routes";
...
export async function createPolicyAction(formData: FormData) {
  ...
  revalidatePath("/hrms/policies");
  redirect(getHrmsPolicyPath(created.id));
}
...
export async function archivePolicyAction(id: string) {
  ...
  revalidatePath("/hrms/policies");
  revalidatePath(getHrmsPoliciesPath());
}
